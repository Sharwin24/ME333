...
#define CORE_TICKS (NU32DIP_SYS_FREQ / 2) // Ticks per second
#define HZ_100 (CORE_TICKS / 100) // 100Hz
#define HZ_200K (CORE_TICKS / 200000) // 200kHz
